...
import { AppBar, Empty, Option, Sheet, Toggle } from '../../components/ui';
import { IconEdit, IconPlus, IconTrash } from '../../components/icons';
import { END_OF_MONTH, PAYMENT_METHODS, type FixedExpense, type PaymentMethod } from '../../types';
              ...
              <div className="list-row" key={f.id}>
                ...
                <span className="list-row-main" style={{ opacity: f.active ? 1 : 0.5 }}>
                  ...
                  <span className="list-row-sub">
                    {f.paymentDay === END_OF_MONTH ? '毎月末' : `毎月${f.paymentDay}日`} ·{' '}
                    {card
                      ? card.name
